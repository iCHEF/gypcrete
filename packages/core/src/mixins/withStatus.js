...
export const statusPropTypes = {
  ...
  errorMsg: PropTypes.oneOfType([PropTypes.arrayOf(PropTypes.node), PropTypes.node]),
};
...
const withStatus =
  ({ withRef = false, withRawStatus = false, ...defaultStatusOptions } = {}) =>
  (WrappedComponent) => {
