...
class InfiniteScroll extends PureComponent {
  ...
  detachScrollListener = () => {
    if (this.scrollContainer) {
      this.scrollContainer.removeEventListener('scroll', this.handleScrollListener);
    }
  };
   ...
   */
  renderFooter() {
    const { isLoading, hasMore, showMoreButton, noNewestButton } = this.props;
    ...
    return <div className={BEM.footer}>{footerChild}</div>;
  }
