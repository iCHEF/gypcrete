...
type OwnProps = {
    inEdit?: boolean;
    onEditEnd?: (...args: any[]) => any;
    onDblClick?: (...args: any[]) => any;
    icon?: any; // TODO: TextLabel.propTypes.icon
    basic?: any; // TODO: TextLabel.propTypes.basic
    align?: any; // TODO: TextLabel.propTypes.align
    status?: any; // TODO: TextLabel.propTypes.status
};

type State = any;

type Props = OwnProps & typeof EditableTextLabel.defaultProps;
...
class EditableTextLabel extends PureComponent<Props, State> {
    static defaultProps = {
        inEdit: undefined,
        onEditEnd: () => {},
        onDblClick: () => {},
    ...
    render() {
        ...
        if (!stateInEdit && status !== STATUS.LOADING) {
            return (
                <TextLabel
                    status={status}
                    // @ts-expect-error ts-migrate(2769) FIXME: Property 'onDoubleClick' does not exist on type 'I... Remove this comment to see the full error message
        ...
        return (
            <TextLabel {...labelProps}>
                ...
                <EditableText
                    // @ts-expect-error ts-migrate(2769) FIXME: Property 'defaultValue' does not exist on type 'In... Remove this comment to see the full error message
                    defaultValue={basic}
